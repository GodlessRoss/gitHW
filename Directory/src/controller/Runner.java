	...
	private static Theme[] generateThemes() {
		Theme them1 = new Theme("Введение в технологию Java",
				"В современном мире существует множество различных операционных систем (Windows, Mac OS, Unix-подобные). Программное обеспечение, написанное для одной системы, не будет работать на другой операционной системе. Это связано с различным устройством исполняемых файлов и функций операционных систем. Java позволяет решить проблему запуска одного приложения на различных ОС, предлагая пользователям не только язык разработки, но и целую платформу. "
						...
						+ "Март и семантике. За основу объектной модели взят подход из языка Smalltalk. Сравнение С++ и Java: ■ в Java отсутствует перегрузка операторов; ■ в Java отсутствует прямой доступ к памяти через указатель; ■ в Java отсутствуют деструкторы; ■ в Java отсутствует возможность процедурного программирования; ■ в Java статическая длина массивов и проверка индекса при доступе к элементу; ■ в Java значение переменных экземпляра (полей класса), в случае отсутствия инициализации, принимают значения по умолчанию (для целых и дробных типов это 0, для boolean – это false, для ссылочных типов – это null); ■ в Java отсутствуют препроцессорные операции; ■ в Java отсутствуют файлы заголовки (header); ■ в Java контроль за расходом памяти возложен на специальный механизм сборки мусора, в С++ за этим следит сам программист. Платформы Java и ее составные части Java платформа – это набор средств для разработки на языке Java, которые поставляются разработчику в виде единого готового решения. В платформу входят: ■ стандартные библиотеки; ■ средств компиляции; ■ средства выполнения кода;■ средства подготовки документации по коду; ■ примеры; ■ другие средства для разработки. Редакции платформ Java Java платформа поставляться в виде единого пакета разной редакции (комплектации). Для каждой редакции существует отдельная нумерация версий платформы.  ■ JSE или J2SE (Java Standart Edition) – это стандартная редакция платформы Java, используемая при разработке консольных приложений, в виде апплетов или stendelone приложений с графическим интерфейсом, приложений работающих с базами данных и сетью.  ■ JEE или J2EE (Java Enterprise Edition) – это редакция платформы, которая предназначена для разработки распределенных приложений уровня предприятия. Содержит в себе технологии Servlet, JSP, EJB. ■ JME (Java Micro Edition) – это редакция платформы, которая предназначена для разработки приложений под микрокомпьютеры (мобильные телефоны, планшеты и т.д.). В нее входят облегченные стандартные классы и классы для написания мидлетов (Midlets).  ■ Java FX – это платформа (2007 г.) для разработки приложений с графическим интерфейсом. Включена в  8 JSE, до этого была отдельной библиотекой. ");
