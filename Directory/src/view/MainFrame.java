				...
				.addGroup(groupLayout.createSequentialGroup()
						...
						.addGroup(groupLayout.createParallelGroup(Alignment.LEADING, false).addComponent(lblNewLabel)
								.addComponent(addTestButton, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE,
										Short.MAX_VALUE)
								.addGroup(groupLayout.createSequentialGroup().addComponent(runTestButton)
										.addPreferredGap(ComponentPlacement.RELATED).addComponent(btnX))
								.addComponent(addTestScrollPane, Alignment.TRAILING, GroupLayout.PREFERRED_SIZE, 140,
										GroupLayout.PREFERRED_SIZE))
						.addContainerGap()));
		groupLayout.setVerticalGroup(groupLayout.createParallelGroup(Alignment.LEADING).addGroup(groupLayout
				.createSequentialGroup().addContainerGap()
				.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
						.addComponent(themeScrollPane, Alignment.TRAILING, GroupLayout.DEFAULT_SIZE, 284,
								Short.MAX_VALUE)
						...
						.addGroup(groupLayout.createSequentialGroup().addComponent(lblNewLabel)
								...
								.addGroup(groupLayout.createParallelGroup(Alignment.BASELINE)
										.addComponent(runTestButton).addComponent(btnX))
								.addGap(7).addComponent(addTestButton))
						.addComponent(scrollPaneTree, Alignment.TRAILING, GroupLayout.DEFAULT_SIZE, 284,
								Short.MAX_VALUE))
				.addContainerGap()));
